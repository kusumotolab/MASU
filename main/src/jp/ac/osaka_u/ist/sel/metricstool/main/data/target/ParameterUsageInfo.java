...
public final class ParameterUsageInfo extends VariableUsageInfo<ParameterInfo> {
    ...
    public static ParameterUsageInfo getInstance(final ParameterInfo usedParameter,
            ...
            final int toColumn) {
        final ParameterUsageInfo instance = new ParameterUsageInfo(usedParameter, reference, fromLine, fromColumn, toLine, toColumn);
     ...
     */
    public final static Set<ParameterUsageInfo> getUsages(
