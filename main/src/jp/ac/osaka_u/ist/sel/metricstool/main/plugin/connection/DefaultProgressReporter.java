 ...
 * コンストラクタにプラグインインスタンスを与える.
 * このクラスの複数のインスタンスを同じプラグインから作ることはできない.
 * @author kou-tngt
 *
 */
public class DefaultProgressReporter implements ProgressReporter {
    ...
    /**
     * 唯一のコンストラクタ.
     * 引数にプラグインインスタンスを受け取り，報告用の接続を確立する
     * @param plugin 進捗報告をするプラグイン
     * @throws AlreadyConnectedException すでに同じプラグインインスタンスが別のレポーターで接続を作っている場合
     */
    public DefaultProgressReporter(final AbstractPlugin plugin) throws AlreadyConnectedException {
        //このプラグイン用のコネクタを作って，接続
