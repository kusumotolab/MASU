...
class Java14Parser extends Parser;

options {
	k = 2;							// two token lookahead
	exportVocab=Java14;				// Call its vocabulary "Java15"
...

{
	...
	private Java14Lexer lexer;

	public Java14Parser(Java14Lexer lexer){
		this(lexer,2);
		this.lexer = lexer;
	}
...
// The Java scanner
//----------------------------------------------------------------------------
class Java14Lexer extends Lexer;

options {
	exportVocab=Java14;		// call the vocabulary "Java15"
