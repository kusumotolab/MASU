 ...
 * @author higo
 */
public final class UnresolvedForBlockInfo extends UnresolvedBlockInfo<ForBlockInfo> {
    ...
    public ForBlockInfo resolveUnit(final TargetClassInfo usingClass,
        ...
        this.resolvedInfo = new ForBlockInfo(usingClass, usingMethod, fromLine, fromColumn, toLine,
                toColumn);
