...
class Java13Parser extends Parser;

options {
	k = 2;							// two token lookahead
	exportVocab=Java13;				// Call its vocabulary "Java15"
...
// The Java scanner
//----------------------------------------------------------------------------
class Java13Lexer extends Lexer;

options {
	exportVocab=Java13;		// call the vocabulary "Java15"
