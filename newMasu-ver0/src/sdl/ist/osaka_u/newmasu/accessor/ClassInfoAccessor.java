...
public class ClassInfoAccessor extends UnitInfoAccessor {
	 ...
	 * @return スーパークラスのset
	 */
	public static Set<AbstractTypeDeclaration> getSuperClass(TypeDeclaration node) {
	 ...
	 * @return サブクラスのset
	 */
	public static Set<AbstractTypeDeclaration> getSubClass(TypeDeclaration node) {
