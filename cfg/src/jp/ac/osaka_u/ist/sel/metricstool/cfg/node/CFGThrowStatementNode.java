...
public class CFGThrowStatementNode extends CFGStatementNode<ThrowStatementInfo> {
    ...
    ExpressionInfo getDissolvingTarget() {
        ...
        return (ExpressionInfo) statement.getThrownExpression().copy();
    }

    @Override
    ThrowStatementInfo makeNewElement(final LocalSpaceInfo ownerSpace, final int fromLine,
        ...
        final ThrowStatementInfo newStatement = new ThrowStatementInfo(ownerSpace,
                requiredExpression[0], fromLine, fromColumn, toLine, toColumn);
        return newStatement;
    }
