...
public class ElementInfo implements Comparable<ElementInfo> {
     ...
     * @param toColumn 終了列
     */
    public ElementInfo(final int fileID, final int fromLine, final int fromColumn,
