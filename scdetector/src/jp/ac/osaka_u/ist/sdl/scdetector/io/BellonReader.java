    ...
    public static void read(final String filename, final String id) {
        ...
        try {
            ...
            while (reader.ready()) {
                ...
                //final int typeNumber = Integer.parseInt(tokenizer.nextToken());

                final ElementInfo element1 = new ElementInfo(filename1.hashCode(), fromLine1, 0,
                        toLine1, 0);
                final ElementInfo element2 = new ElementInfo(filename2.hashCode(), fromLine2, 0,
                        toLine2, 0);
