...
public class InterProceduralPDG extends PDG {
    ...
    public InterProceduralPDG(final Collection<IntraProceduralPDG> pdgs,
            final boolean buildDataDependency, final boolean buildControlDependency,
    ...
    public InterProceduralPDG(final Collection<CallableUnitInfo> methods,
            final IPDGNodeFactory pdgNodeFactory, final ICFGNodeFactory cfgNodeFactory,
            final boolean buildDataDependency, final boolean buildControlDependency,
            final boolean buildExecutionDependency, final boolean countObjectStateChange,
            final boolean optimize, final int dataDependencyDistance,
            final int controlDependencyDistance, final int executionDependencyDistance) {
    ...
    public InterProceduralPDG(final Collection<CallableUnitInfo> methods,
        ...
        this(methods, new DefaultPDGNodeFactory(), new DefaultCFGNodeFactory(),
                buildDataDependency, buildControlDependency, buildExecutionDependency,
                countObjectStateChange, optimize, dataDependencyDistance,
                controlDependencyDistance, executionDependencyDistance);
    }
    ...
    public InterProceduralPDG(final Collection<CallableUnitInfo> methods,
        ...
        this(methods, buildDataDependency, buildControlDependency, buildExecutionDependency,
                countObjectStateChange, optimize, Integer.MAX_VALUE, Integer.MAX_VALUE,
                Integer.MAX_VALUE);
    }
    ...
    protected void buildPDG() {
        ...
        for (final CallableUnitInfo method : this.methods) {
            final IntraProceduralPDG pdg = new IntraProceduralPDG(method, this.pdgNodeFactory,
                    this.cfgNodeFactory, this.buildDataDependency, this.buildControlDependency,
                    this.buildExecutionDependency, this.countObjectStateChange, this.optimize,
                    true, this.dataDependencyDistance, this.controlDependencyDistance,
