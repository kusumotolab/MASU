...
public class MethodInfoAccessor extends UnitInfoAccessor {
	 ...
	 */
	public static TypeDeclaration getDeclaringClass(MethodDeclaration node) {
		...
		TypeDeclaration td = (TypeDeclaration) BindingManager.getDec().get(
				tBinding);
	 ...
	 */
	public static Set<ASTNode> getAssignedFields(MethodDeclaration node) {
